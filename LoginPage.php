...
<html>
    ...
    <head>
        ...
        <meta charset="utf-8" />
        <script src="ArchivosJS/jquery.js"></script>
    ...
    <body id="back">
        ...
        <section id="login_section">
            <br></br>
            <div>
                <form id="fr" method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                    <label>Nombre de usuario</label>
                    <input type="text" id="nomUsuario" name="nomUsuario">
                    <br></br>
                    <label>Contraseña<label>
                    <input type="password" id="conUsuario" name="conUsuario">
                    <input type="submit" value="Login">
                </form>
            </div>
        </section>
        <a id="registrarse" href="RegistrarCliente.html"><B>Registrarse</B></a>
    </body>
